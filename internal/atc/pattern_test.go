...
func TestDetectPatternLeg(t *testing.T) {
	...
	cases := []struct {
		...
		{"Al Minhad tower, genius 1-1, direct approach on short final full stop", air, legFinal},
		{"Genius 1-1 direct approach runway 27", air, legStraight},
		{"Genius 1-1 straight in runway 27", air, legStraight},
		{"good morning", gnd, legGreeting},
